...
import '../../features/manager/today_report/today_report_screen.dart';
...
class AppRoutes {
  ...
  static const String managerTodayReport = '/manager/today-report';
}
...
GoRouter createAppRouter({String initialLocation = AppRoutes.main}) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: AppRoutes.managerTodayReport,
