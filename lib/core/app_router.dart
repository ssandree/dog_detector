...
import '../screens/manager_mode/realtime/video_evidence_screen.dart';
...
class AppRoutes {
  ...
  static const String videoEvidence = '/video/evidence/:emotionName/:timeText';
}
...
final GoRouter appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: AppRoutes.videoEvidence,
      name: 'videoEvidence',
      builder: (context, state) {
        final emotionName = state.pathParameters['emotionName'] ?? '';
        final timeText = state.pathParameters['timeText'] ?? '';
        return VideoEvidenceScreen(
