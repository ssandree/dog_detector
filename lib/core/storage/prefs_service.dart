...
class PrefsService {
  ...
  String? getAccessToken() => _sp.getString(_keyAccessToken);
  ...
  Future<void> setAutoLogin(bool v) => _sp.setBool(_keyAutoLogin, v);
  ...
  Future<void> setAccessToken(String? token) async {
    if (token == null) {
      ...
      await _sp.setString(_keyAccessToken, token);
    }
  }
}
