...
import '../application/emotion_data_provider.dart';
...
class _EmotionGaugeCardState extends ConsumerState<EmotionGaugeCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return asyncData.when(
      data: (result) {
        ...
        final gaugeColor = _calculateEmotionColor(ratio);
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color:
                            (isEmpty ? AppColors.grey6 : color).withOpacity(0.3),
                        blurRadius: 8,
  ...
  Widget _buildEmotionBox(Map<String, dynamic> item) {
    ...
    final bg = color.withOpacity(0.4);
