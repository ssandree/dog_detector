...
class AppColors {
  ...
  // AppBar 색상
  static const Color primaryAppBarColor = Color(0xFF2196F3);    // 파란색 (매니저모드)
  static const Color secondaryAppBarColor = Color(0xFF4CAF50);  // 녹색 (캠모드)
  ...
  // UI 요소 색상
  static const Color primaryButtonColor = Color(0xFF6B73FF);
